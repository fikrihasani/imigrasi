...
@section('content')
    <div class="container" style="margin-bottom: 20px">
        <section class="span10  ">
            <div  class="col-right">
                <h1 Align="Center">Statistik Keimigrasian</h1>     
                    <div class="row">
                        <div class="span3">
                            <label>Tahun Statistik</label>
                            <br/>
                            <select id="tahun_survei" class="span3">
                    ...
                    <div class="row">
                        <div class="span10">                    
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#bula1" data-toggle="tab">Januari</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="bulan5">
                                    Sed pretium, ligula sollicitudin laoreet viverra,Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapi
                                </div>
