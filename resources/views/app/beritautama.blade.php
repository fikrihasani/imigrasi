...
@section('content')
    <section class="span10  ">
        <div class="col-right">
        <h2 align="center"><a>Berita Utama</a></h2>
        <br/>
        <hr/>
            <div class="strip-lessons">
                <div class="row">
                    <div class="span3">
                        <div class="box-style-one borders"><img src="img/lessons.png" alt=""><h5>Intro one</h5></div>
                    </div>
                    <div class="span5">
           			    <span class="label label-default">Imigrasi News</span> |<i class="icon-calendar"></i> 11 Juli 2018, 12:36 
