                        ...
                        <div class="strip-lessons">
                            <div class="row">
                                ...
                                <div class="span5">
                                    ...
                                    <div class="actions"><a href="/beritautama/{{$berita->id}}"	class="button_medium pull-right">Read more <i class="icon-chevron-right"></i></a></div>
                                </div>
                            </div>
                ...
                @else
                    <center>
                        <div class="alert alert-info">
                            <h3>Maaf Belum ada Berita Utama</h3>
                        </div>
                    </center>
                @endif
            </div><!-- end col right-->	
